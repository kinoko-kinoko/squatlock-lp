              ...
              <div className="pt-6 w-full max-w-lg">
                {abVariant === 'A' ? (
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start leading-none">
                      <span className="text-xs font-bold uppercase tracking-wider mb-1 opacity-60">100% Free</span>
                      <span className="text-2xl font-black tracking-tighter">Download Now</span>
                    </div>
                  </button>
                )}
              </div>
